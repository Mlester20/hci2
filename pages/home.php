                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <input type="checkbox" id="check_m_<?php echo $id; ?>" name="m[]" value="<?php echo $id; ?>" style="width: 20px; height: 20px;" onchange="toggleCheckbox('check_t_<?php echo $id; ?>', this.checked)">
                                                                </td>
                                                                <td class="text-center">
                                                                    <input type="checkbox" id="check_t_<?php echo $id; ?>" name="t[]" value="<?php echo $id; ?>" style="width: 20px; height: 20px;" onchange="toggleCheckbox('check_w_<?php echo $id; ?>', this.checked)">
                                                                </td>
                                                                <td class="text-center">
                                                                    <input type="checkbox" id="check_w_<?php echo $id; ?>" name="w[]" value="<?php echo $id; ?>" style="width: 20px; height: 20px;" onchange="toggleCheckbox('check_th_<?php echo $id; ?>', this.checked)">
                                                                </td>
                                                                <td class="text-center">
                                                                    <input type="checkbox" id="check_th_<?php echo $id; ?>" name="th[]" value="<?php echo $id; ?>" style="width: 20px; height: 20px;" onchange="toggleCheckbox('check_f_<?php echo $id; ?>', this.checked)">
                                                                </td>
                                                                <td class="text-center">
                                                                    <input type="checkbox" id="check_f_<?php echo $id; ?>" name="f[]" value="<?php echo $id; ?>" style="width: 20px; height: 20px;">
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="remarks" id="remarks" cols="30" rows="3" placeholder="Enclose remarks with parenthesis()"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Form Buttons -->
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="room_sched.php" target="_blank">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select class="select2" name="room" id="room_search" style="width:90%!important" required>
                                    <?php
                                    $query2 = mysqli_query($con, "SELECT * FROM room ORDER BY room") or die(mysqli_error($con));
                                    while ($row = mysqli_fetch_array($query2)) {
                                    ?>
