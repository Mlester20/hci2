...
<body class="hold-transition skin-green layout-top-nav" onload="myFunction()">
											...
											<div class="col-md-6">
												<table class="table table-bordered table-striped">
													...
													?>
														<tr>
															<td><?php echo $start . "-" . $end; ?></td>
															<td><input type="checkbox" id="check_th_<?php echo $id; ?>"
																	name="th[]" value="<?php echo $id; ?>"
																	style="width: 20px; height: 20px;"
																	onchange="toggleCheckbox('check_f_<?php echo $id; ?>', this.checked)">
															</td>
															<td><input type="checkbox" id="check_f_<?php echo $id; ?>"
								...
								<div class="box-body">
									<div id="form1">
										...
										<div class="form-group">
											...
											<button class="btn btn-lg btn-primary" id="daterange-btn" name="save"
												type="submit">
												Save
											</button>
	...
	<div id="searcht" class="modal fade in" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
		style="display: none;">
	...
	<div id="searchclass" class="modal fade in" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
		style="display: none;">
		<div class="modal-dialog">
			<div class="modal-content" style="height:auto">
				<div class="modal-header">
	...
	<div id="searchroom" class="modal fade in" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
		style="display: none;">
		<div class="modal-dialog">
			<div class="modal-content" style="height:auto">
				<div class="modal-header">
