 ...
 <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
 	...
 	<div id="searcht" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
 	...
 	<div id="searchclass" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
 		aria-hidden="true" style="display: none;">
 		<div class="modal-dialog">
 			<div class="modal-content" style="height:auto">
 				<div class="modal-header">
 	...
 	<div id="searchroom" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
 		aria-hidden="true" style="display: none;">
 		<div class="modal-dialog">
 			<div class="modal-content" style="height:auto">
 				<div class="modal-header">
 	...
 	<script>
 		function toggleCheckbox(checkboxId, isChecked) {
 			...
 			if (checkbox) {
 				checkbox.disabled = isChecked; // Disable or enable based on the checkbox status
 				if (isChecked) {
 					checkbox.checked = false; // Uncheck the "T" checkbox if "M" is checked
 				}
 			}
 		}
 	</script>
