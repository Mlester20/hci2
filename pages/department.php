...
<body class="hold-transition skin-green layout-top-nav" onload="myFunction()">
    ...
    ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $name;?></td>
                                                    <td><a id="click"
                                                            href="department.php?id=<?php echo $id;?>&code=<?php echo $code;?>&name=<?php echo $name;?>">
                                                            <i class="glyphicon glyphicon-edit text-blue"></i></a>
                                                        <a id="removeme"
                                                            onclick="return confirm('Are you sure you want this record to be deleted?');"
                                                            href="department_del.php?id=<?php echo $id;?>">
                                            ...
                                            <div class="col-md-12">
                                                <form method="post" action="department_update.php">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="class" name="code"
