                ...
                <section class="content">
                    <div class="row">
                                    ...
                                    <form method="post" action="user_add.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group col-md-12">
                                                <input type="text" class="form-control pull-right" id="date" name="name"
                      ...
                      ?>
                              ...
                              ?></td>
                                                <td>
                                                    <a href="#updateordinance<?php echo $row['user_id']; ?>"
                                                        data-target="#updateordinance<?php echo $row['user_id']; ?>"
                                            ...
                                            <div id="updateordinance<?php echo $row['user_id']; ?>"
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form-horizontal" method="post"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-9"><input type="hidden"
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label col-lg-3"
                                                                        for="price">Username</label>
                                                                    <div class="col-lg-9">
                                                                        <input type="text" class="form-control"
                                                                            id="price" name="username"
